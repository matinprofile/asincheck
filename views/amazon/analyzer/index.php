	...
	<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">				
		...
		<div class="panel price panel-red">
			...
			<ul class="list-group list-group-flush text-center">
				...
				<li class="list-group-item"><i class="icon-ok text-danger">length of each bullet point :</i><?php echo $product->kpi__length_of_each_bullet_point; ?></li>
...
<div class="row">
	<?php if($product->kpi_status__amount_of_reviews){ ?>
		<div class='col-xs-4 col-sm-4 col-md-4 col-lg-4' >
			<div class='alert alert-danger' >
				<strong>Wir empfehlen Ihnen, K?ufer zum Bewerten Ihres Produkts zu motivieren.</strong>
			</div>
		</div>
	<?php }else{ ?>
		<div class='col-xs-4 col-sm-4 col-md-4 col-lg-4' >
	...
	<?php 
	if($product->kpi_status__length_of_description){
	?>
		<div class='col-xs-4 col-sm-4 col-md-4 col-lg-4' >
			<div class='alert alert-danger' >
